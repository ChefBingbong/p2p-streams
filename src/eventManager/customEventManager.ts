 ...
 */
export const setMaxListeners: typeof nodeSetMaxListeners = (
  n,
  ...eventTargets
) => {
  try {
 ...
 * etc
 */
export interface TypedEventTarget<EventMap extends Record<string, any>>
  extends EventTarget {
...
export class TypedEventEmitter<EventMap extends Record<string, any>>
  extends EventTarget
  implements TypedEventTarget<EventMap>
{
  ...
  safeDispatchEvent<Detail>(
    ...
    return this.dispatchEvent(new CustomProgressEvent(type as string, detail));
  }
}
